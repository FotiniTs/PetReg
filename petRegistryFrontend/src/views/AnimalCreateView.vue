...
const { createdAnimal } = storeToRefs(animalStore);
...
async function submitForm(formEl) {
  ...
  formEl.validate(async (valid) => {
    if (valid) {
      ...
      await animalStore.saveAnimal(animal.value);
    } else {
      return false;
    }
  });
  ...
  <el-card class="box-card">
    ...
    >
      <el-form-item label="Microchip Code" prop="microchip_code">
        <el-input-number v-model="animal.microchip_code" />
      </el-form-item>
      <el-form-item label="Type" prop="type">
        <el-radio-group v-model="animal.type">
          <el-radio label="Cat" />
          <el-radio label="Dog" />
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item label="Is missing" prop="missing">
        <el-switch v-model="animal.missing" />
      </el-form-item>
      <el-form-item>
