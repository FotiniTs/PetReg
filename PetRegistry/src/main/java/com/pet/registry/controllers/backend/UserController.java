package com.pet.registry.controllers.backend;
...
public class UserController {
    ...
    @PostMapping("/{id}/edit")
    public String editUser(Model model, @PathVariable("id") int id, @Valid User user, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
    ...
    public String deleteUser(RedirectAttributes redirectAttributes, @PathVariable("id") int id) {
